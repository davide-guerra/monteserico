...
<footer class="bg-verde mt-8">
    <div class="flex flex-col max-w-7xl mx-auto px-4 pt-8 pb-4 gap-8 items-center">
        ...
        <a href="<?php echo( get_field('link_google_maps', $home_id) ); ?>" target="_blank">
            <div class="text-white flex flex-col items-center gap-2">
                ...
                <span class="cursor-pointer hover:opacity-90 text-sm text-center lg:text-left"><?php echo( get_field('indirizzo', $home_id) ); ?></span>
            </div>
        </a>
            <div class="text-white flex flex-col items-center gap-2">
