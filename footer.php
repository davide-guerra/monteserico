        ...
        <div class="flex flex-col lg:grid lg:grid-cols-3 gap-4 lg:gap-6">
            <a href="<?php echo( get_field('link_google_maps', $home_id) ); ?>" target="_blank" class="cursor-pointer text-white hover:opacity-90">
                <div class="flex flex-col items-center gap-2">
                    <svg class="w-8 h-8" style="margin-top:.15em" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                    <span class="text-sm text-center lg:text-left"><?php echo( get_field('indirizzo', $home_id) ); ?></span>
                </div>
            </a>
            <a href="tel:<?php echo( str_replace(' ', '', get_field('telefono', $home_id)) ); ?>" class="cursor-pointer text-white hover:opacity-90">
                <div class="flex flex-col items-center gap-2">
                    ...
                    <span class="text-sm text-center lg:text-left"><?php echo( get_field('telefono', $home_id) ); ?></span>
                </div>
            </a>
            <a href="mailto:<?php echo( get_field('email', $home_id) ); ?>" class="cursor-pointer text-white hover:opacity-90">
                <div class="flex flex-col items-center gap-2">
                    ...
                    <span class="text-sm text-center lg:text-left"><?php echo( get_field('email', $home_id) ); ?></span>
                </div>
            </a>
        </div>
    </div>
