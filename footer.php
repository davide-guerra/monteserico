...
<footer class="bg-verde mt-8">
    ...
    <div class="block text-center lg:flex lg:justify-between max-w-7xl mx-auto py-4 border-t border-white text-white text-xs mt-4">
        <div class="flex flex-col lg:flex-row"><span>&copy; <?php echo(date('Y')); ?> Monteserico Colture Italiane.</span><span class="hidden lg:inline">&nbsp;</span><span><?php echo( (ICL_LANGUAGE_CODE == 'it') ? 'P.IVA.' : 'VAT.' ); ?> 08606270729.</span><span class="hidden lg:inline">&nbsp;</span><span><?php echo( (ICL_LANGUAGE_CODE == 'it') ? 'Tutti i diritti riservati.' : 'All rights reserved.' ); ?></span></div>
