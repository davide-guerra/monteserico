...
<body <?php echo( (is_front_page()) ? 'id="home"' : "" ); ?>class="absolute top-0 w-full min-h-screen flex flex-col">
    <div
        class="w-full z-10 top-0 <?php echo( (is_front_page()) ? 'home-header' : 'internal-header'); ?> bg-white"
