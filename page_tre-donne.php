...
<!-- Banner -->
<section id="banner-section" style="background-image: url(<?php echo( get_field('immagine_banner_1') ); ?>); background-attachment:scroll;" class="w-full flex items-center justify-center bg-fixed bg-center bg-cover my-8">
