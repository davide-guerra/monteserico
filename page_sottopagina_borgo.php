<?php /* Template Name: Sottopagina Borgo */ ?>
<?php
  // Get the header
  get_header( 'fixed' );
?> 
...
// Recuperiamo lo slug del post (o lo slug del post originale nel caso si trattasse di una pagina tradotta).
// Useremo questo slug per il wp_query che cerca le immagini da mostrare in gallery, in modo da visualizzare solo quelle adatte alla pagina corrente.
$original_post_id = apply_filters( 'wpml_object_id', $page_id, 'page', TRUe, 'it' );
$original_post_obj = get_post($original_post_id);
$slug_name = $original_post_obj->post_name;
?>
