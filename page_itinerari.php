...
<section class="w-full lg:flex lg:flex-row lg:flex-row">
<div class="lg:basis-1/2 aspect-[16/9] lg:aspect-[4/3]">
    <img src="<?php echo( get_field('box_6_immagine') ); ?>" class="w-full h-full object-cover">
  </div>
  <div class="lg:basis-1/2 bg-white p-4 flex flex-col justify-center mx-4 lg:mx-0">
    <div class="lg:px-12">
      <h2 class="text-center lg:text-left text-maincolor mb-4 text-2xl lg:text-2xl"><?php echo( get_field('box_6_titolo') ); ?></h2>
      <p class="text-center lg:text-left lg:text-lg mb-4 lg:leading-8"><?php echo( get_field('box_6_testo') ); ?></p>
    </div>
  </div>
</section>
<?php /*
